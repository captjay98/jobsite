...
const user = {
    ...
    qualifications: ref(seeker.qualifications),
    experiences: ref(seeker.experiences),
    skills: ref(seeker.skills),
    cv: ref(seeker.cv),
    visa: ref(seeker.visa),
    passport: ref(seeker.passport),
};
...
<template>
    <AdminLayout>
        <div class="w-full rounded-2xl py-4 m-auto bg-gray-100">
            <div
                class="flex justify-between items-center mb-8 mt-4 m-auto w-full px-4 py-4 bg-white rounded-md"
            >
                <h1 class="text-xl text-left font-semibold py-4">Details</h1>
                <form action="">
            ...
            <div class="w-full flex flex-wrap justify-around bg-white rounded-md my-2 px-1 py-1">
                ...
                <div class="mx-1 my-4 xl:w-[35%] lg:w-50%">
                    ...
                    <form class="my-2 bg-white rounded-md">
                        <div
                            :key="expe.id"
                            v-for="expe in experiences"
                            class="hover:shadow-2xl hover:translate-x-1 border-inherit border-[1px] py-1 px-2 flex my-1 shadow-md flex-wrap justify-around mt-1 m-auto w-full rounded-md"
                        >
                            <div
