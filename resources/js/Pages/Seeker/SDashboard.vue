    ...
    <AuthenticatedLayout>
        <SeekerLayout>
            ...
            <div class="h- bg-white rounded-md px-4 py-4 my-8">
                ...
                >
                    <h1 class="text-2xl text-center">You currently do not have an Application.</h1>
                </div>
                <div class="my-4 w-full h-auto px-4 py-4">
                    <div class="flex flex-wrap justify-around">
                        <div
                            v-for="application in applications"
                            class="bg-blue-300 shadow-2xl h-48 w-48 mx-2 my-4 px-2 py-2 flex flex-wrap rounded-md"
                            :class="{
                        ...
                        >
                            <Link :href="route('seeker.applications.one', application.id)">
                                <div
                                    class="flex flex-wrap justify-evenly py-1 my-1 w-full text-center"
                                >
                                ...
                                >
                                    <span class="text-sm mx-8">Status:</span>
                                    <span class="text-sm font-semibold">{{
                                ...
                                >
                                    <span class="text-sm mx-8">Date Applied: </span>
                                    <span class="text-sm font-semibold">{{
            ...
            <div class="h- bg-white rounded-md px-4 py-4 my-8">
                <div class="mb-6">
                    <h1 class="text-semibold text-xl text-center">
