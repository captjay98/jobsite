    ...
    <div class="w-full bg-white flex flex-wrap justify-center rounded-md my-4 px-2 py-2 border-slate-800">
        <div class="lg:w-[48%] mx-3 m-auto h-auto">
            ...
            <form class="flex flex-wrap justify-center" @submit.prevent="updateSkill">
                ...
                <div v-for="skill in skills" class="flex flex-wrap mt-8 m-auto justify-center rounded-md">
                    <div class="text-sm text-left pt-2 px-2">
                        <input class="flex w-16 border-slate-200 shadow-sm rounded-md font-semibold" id="from"
                            v-model="skill.from" />
                    </div>
                </div>
                <div class="mx-2 w-full mb-4 flex flex-wrap justify-around">
                    <div class="text-sm text-left pt-2 px-2">
                        ...
                        <input class="flex h-8 w-56 bg-gray-100 border-slate-300 shadow-xl rounded-md font-semibold"
                            type="text" id="from" @input="updatedFields.skill.from = true" />
                    </div>
                </div>
