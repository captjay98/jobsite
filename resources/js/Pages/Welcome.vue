...
<template>
    ...
    <div class="mt-12 w-screen h-auto bg-blue-100">
        <div class="bg-slate-100 min-h-auto">
            <div class="flex flex-wrap justify-between md:py-20 md:mt-20">
                <div class="max-sm:px-2 max-sm:pt-20 lg:w-[90%] xl:w-[40%] mb-[4.5rem] m-auto w-full py-4 max-sm:mb-10">
                    <div class="px-2">
                        <h1 class="tracking-tight leading-tight text-center text-[3.3rem] max-sm:text-[2.6rem]">
                            Welcome to
                            <span class="text-blue-500">JobSite</span>
                        </h1>
                        <h2 class="text-3xl tracking-tight leading-tight text-center max-sm:text-[1.45rem]">
                            The ultimate hub where talents and opportunities
                            converge.
                        </h2>
                        <p class="my-2 leading-6 text-center text-md max-sm:px-5 max-sm:text-[0.9rem] md:px-[2.2rem]">
                            Whether you're a job seeker eager to find your
                            perfect role or an employer searching for top-tier
                            talent, our platform is your gateway to success. Job
                            seekers, explore a myriad of openings tailored to
                            your skills, while employers gain access to a pool
                            of qualified candidates.
                        </p>
                    </div>
                    <div class="m-auto lg:w-[35rem]">
                        <Search />
                    </div>
                </div>
                <div
        ...
        <div class="py-28 px-8 my-16 h-auto bg-blue-100 lg:px-28">
            <div class="flex flex-wrap justify-between items-center mb-4">
                ...
                <div class="lg:w-[50%] md:px-8 w-full lg:px-8 px-2 py-16">
                    ...
                    <button class="py-2 px-3 my-2 bg-blue-500 rounded-md text-slate-900">
                        Search Jobs
                    </button>
                    </Link>
                </div>
        ...
        <div class="py-8 px-8 bg-blue-100 min-h-auto">
            ...
            <div class="flex flex-wrap justify-center py-4 px-1 m-auto w-full rounded-xl">
                <div :key="job.id" v-for="job in jobs" class="py-1 px-1 my-4 mx-4 rounded-xl shadow-sm">
                    <div class="py-1 px-1 my-4 w-60 h-72 rounded-2xl bg-slate-100">
                        <div class="py-1 px-1 w-full h-full rounded-2xl bg-slate-100">
                            <div class="py-2 px-2 w-full h-3/4 bg-blue-300 rounded-2xl">
                                <div class="py-1 px-2 my-1 w-24 text-sm text-center bg-white rounded-xl">
                                    2023-10-16
                                </div>
                                <div class="flex justify-between px-2 mt-4 rounded-xl">
                                ...
                                <div class="flex flex-wrap py-1 px-1 pt-6 text-[10px]">
                                    <p class="py-1 px-1 my-1 mr-1 rounded-xl border-gray-700 border-[1px]">
                                        {{ job.industry }}
                                    </p>
                                    <p class="py-1 px-1 my-1 mr-1 rounded-xl border-gray-700 border-[1px]">
                                        junior-level
                                ...
                                <div class="px-1 pt-1 mt-4 text-sm font-semibold">
                                    {{ job.salary }}
                                </div>
    ...
    <div class="py-8 px-2 h-auto min-h-screen bg-slate-100">
        <div class="flex flex-wrap justify-center">
            <div class="grid grid-cols-2 justify-center m-auto my-16 md:grid-cols-4">
